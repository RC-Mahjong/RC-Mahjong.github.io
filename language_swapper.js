const languageData = {
    "en": {
      ...
      "links_text": `Our Discord server: <a href="https://discord.gg/QdEepy256F" target="_blank">Discord</a></p>
                    ...
                    <p>Disclaimer: Mahjong Soul (MJS) has some anime clichés in it and also includes some character designs that might be NSFW and makes money with the questionable Gacha system. If that bothers you, as an alternative, <a href="https://tenhou.net/3/" target="_blank">Tenhou</a> is also a popular mahjong client, however it is a bit less beginner-friendly due to a shorter time limit and the lack of tip functions. In addition, you will need a browser extension to play Tenhou in English (<a href="https://addons.mozilla.org/en-US/firefox/addon/tenhou-ui-translator/" target="_blank">Firefox Addon</a>, <a href="https://chromewebstore.google.com/detail/tenhou-english-ui/cbomnmkpjmleifejmnjhfnfnpiileiin?pli=1" target="_blank">Chrome Extension</a>), otherwise the site is in Japanese. On the plus side, Tenhou features the fastest, least distracting experience.</p>
    ...
    "de": {
      ...
      "links_text": `Unser Discord-Server: <a href="https://discord.gg/QdEepy256F" target="_blank">Discord</a></p>
                    ...
                    <p>Disclaimer: Mahjong Soul (MJS) hat einige Anime-Klischees und auch ein paar Figurendesigns, die eventuell NSFW sind und finanziert sich über das fragwürdige Gacha-Modell. Falls dies stört, gibt es auch <a href="https://tenhou.net/3/" target="_blank">Tenhou</a>, eine weitere beliebte Online-Mahjong-Seite, als Alternative. Diese ist jedoch etwas weniger einsteigerfreundlich aufgrund von kürzerem Zeitlimit und weniger Tipps und Hilfen. Weiterhin braucht es eine Browser-Extension/ein Browser Add-On, um die Seite auf Englisch zu benutzen (<a href="https://addons.mozilla.org/en-US/firefox/addon/tenhou-ui-translator/" target="_blank">Firefox Addon</a>, <a href="https://chromewebstore.google.com/detail/tenhou-english-ui/cbomnmkpjmleifejmnjhfnfnpiileiin?pli=1" target="_blank">Chrome Extension</a>), da sie ansonsten nur Japanisch ist. Auf der positiven Seite hat Tenhou jedoch das schnellste und am wenigsten ablenkende Gameplay.</p>
